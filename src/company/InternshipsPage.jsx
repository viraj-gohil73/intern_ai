        ...
        {internships.map((intern) => (
          ...
          >
            ...
            <p className="text-sm text-gray-700 mb-2">
              <span className="font-semibold">Skills:</span> {intern.skills}
            </p>
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Duration:</span> {intern.duration}
            </p>
            <p className="text-sm text-gray-700">
              <span className="font-semibold">Stipend:</span> ₹{intern.stipend}
            </p>
            <p className="text-sm text-gray-700">
